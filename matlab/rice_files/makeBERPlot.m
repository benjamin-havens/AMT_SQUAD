...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% RESULTS W/O HC USING MRC %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% This is for wo_hc/0a.mat
% errors =  [370    580    1340   2222   2960   4512   5342];
N0MRC0a_VH =  [24     25     26     27     28     29     30];
BERMRC0a_VH = [7.1e-5 3.3e-4 1.2e-3 3.6e-3 8.7e-3 1.8e-2 3.4e-2];

% This is for wo_hc/10a.mat
% errors =   [326    584    954    1616   1988   2574   3292   3226];
N0MRC10a_VH =  [23     24     25     26     27     28     29     30];
BERMRC10a_VH = [2.2e-5 1.1e-4 5.2e-4 1.8e-3 4.7e-3 1.1e-2 2.6e-2 4.4e-2];

% This is for wo_hc/20a.mat
% errors =  [];
N0MRC20a_VH =  [23	24	25	26	27	28];
BERMRC20a_VH = [2.75e-5 1.49e-4 6.16e-4 1.99e-3 5.23e-3 1.22e-2];

% This is for wo_hc/30a.mat
% errors =   [];
N0MRC30a_VH =  [23 24 25 26 27 28];
BERMRC30a_VH = [6.95e-5 3.25e-4 1.113e-3 3.26e-3 8.4e-3 1.81e-2];

% This is for wo_hc/40a.mat
% errors =  [4528 3080 3646 1078 1342 646];
N0MRC40a_VH =  [27 26 25 24 23 22];
BERMRC40a_VH = [0.01383 0.006067 0.002381 0.0006866 0.0001835 3.2e-5];

% This is for wo_hc/50a.mat
% errors =   [1.552e4 8066 2690 2010 966 650];
N0MRC50a_VH =  [27 26 25 24 23 22];
BERMRC50a_VH = [0.01458 0.006513 0.002484 0.0007881 0.0001893 3.674e-5];

% This is for wo_hc/60a.mat
% errors =  [1.057e4 2.17e4 4080 2322 868 330 212];
N0MRC60a_VH =  [26 25 24 23 22 21 20];
BERMRC60a_VH = [0.02568 0.01294 0.005615 0.002161 0.0006595 0.0001766 2.687e-5];

% This is for wo_hc/70a.mat
% errors =   [2308 2256 1924 2120 734 256];
N0MRC70a_VH =  [25 24 23 22 21 20];
BERMRC70a_VH = [0.01311 5.4e-3 2.1e-3 0.0006457 0.0001574 2.948e-5];

% This is for wo_hc/80a.mat
% errors =  [3544 4370 1946 1056 334 210];
N0MRC80a_VH =  [25 24 23 22 21 20];
BERMRC80a_VH = [0.01018 0.004253 0.001467 0.0004379 9.69e-5 1.53e-5];

% This is for wo_hc/90a.mat
% errors =   [1.142e4 2.04e4 3604 1256 736 322];
N0MRC90a_VH =  [26 25 24 23 22 21];
BERMRC90a_VH = [0.01234 0.005502 0.002054 0.0006438 0.0001684 2.812e-5];

...
#
# Generated by Vivado on Fri Jul 15 13:09:07 MDT 2022
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../pn11_tx.gen/sources_1/ip/clk_wiz_1/clk_wiz_1_clk_wiz.v" \
    "$ref_dir/../../../../pn11_tx.gen/sources_1/ip/clk_wiz_1/clk_wiz_1.v" \
  2>&1 | tee -a vlogan.log
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/plwalker/AMT_SQUAD/frame_sync/pn11_tx/pn11_tx.cache/compile_simlib/vcs"
  fi
